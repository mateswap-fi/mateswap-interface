    ...
    test('LAC to DAI', () => {
      expect(
        queryParametersToSwapState(
          parse(
            '?inputCurrency=LAC&outputCurrency=0x6b175474e89094c44da98b954eedeac495271d0f&exactAmount=20.5&exactField=outPUT',
