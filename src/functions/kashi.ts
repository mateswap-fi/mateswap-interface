...
import {
  FACTOR_PRECISION as _FACTOR_PRECISION,
  FULL_UTILIZATION_MINUS_MAX as _FULL_UTILIZATION_MINUS_MAX,
  INTEREST_ELASTICITY as _INTEREST_ELASTICITY,
  MAXIMUM_INTEREST_PER_YEAR as _MAXIMUM_INTEREST_PER_YEAR,
  MAXIMUM_TARGET_UTILIZATION as _MAXIMUM_TARGET_UTILIZATION,
  MINIMUM_INTEREST_PER_YEAR as _MINIMUM_INTEREST_PER_YEAR,
  MINIMUM_TARGET_UTILIZATION as _MINIMUM_TARGET_UTILIZATION,
